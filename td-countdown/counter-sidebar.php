		...
		<div class="row">
			<div class="col">
				<?php if ($this->getValue('countdownHeading')) : ?>
					<div class="mbr-section-title mb-1 text-<?php echo $this->getValue('countdownAlign') ?> mbr-fonts-style" style="font-size: calc(<?php echo $this->getValue('countdownHeadingSize') ?>rem * 0.75); line-height: <?php echo $this->getValue('countdownHeadingSize') ?>rem">
						<?php echo $this->getValue('countdownHeading') ?>
					</div>
				<?php endif ?>

				<div class="countdown-cont text-center mb-1">
					...
					<div class="countdown countdown-sidebar" data-due-date="<?php echo $this->getValue('date') ?>"></div>
				</div>

				<?php if ($this->getValue('countdownMessage') !== NULL) : ?>
					<div class="mbr-text text-<?php echo $this->getValue('countdownAlign') ?> countdown-sidebar">
